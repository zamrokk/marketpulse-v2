...
export interface MarketpulseInterface extends Interface {
  ...
  getEvent(nameOrSignatureOrTopic: "NewBet" | "Pong"): EventFragment;
...
export namespace NewBetEvent {
  export type InputTuple = [bet: Marketpulse.BetStruct];
  export type OutputTuple = [bet: Marketpulse.BetStructOutput];
  export interface OutputObject {
    bet: Marketpulse.BetStructOutput;
  }
...
export interface Marketpulse extends BaseContract {
  ...
  filters: {
    "NewBet(tuple)": TypedContractEvent<
      NewBetEvent.InputTuple,
      NewBetEvent.OutputTuple,
      NewBetEvent.OutputObject
    >;
